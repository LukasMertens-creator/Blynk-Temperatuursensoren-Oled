...
char auth[] = "sC4GzYzsavMA31DpipiPHcVttlimvAuL";
...
DeviceAddress sensor1 = { 0x28, 0x31, 0x92, 0x9C, 0xB, 0x0, 0x0, 0xC2 };
DeviceAddress sensor2 = { 0x28, 0xE9, 0x25, 0x9B, 0xB, 0x0, 0x0, 0x3F };
...
void setup() {
  ...
  Blynk.begin(auth, ssid, pass , "https;//server.wyns.it", 9443);
...
void loop () {
  ...
  // KTY81 sensoren met een adc --> ADS1115
  int16_t adc0;
